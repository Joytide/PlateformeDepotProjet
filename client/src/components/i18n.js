		...
		resources: {
			en: {
				translation: {
					...
					descriptionProj: { label: 'A complete description of your project: presentation, context, stakeholders, prerequisites (required skills, knowledge, software use...), objectives, potential constraints, expected end product and deliverables ', },
					finish: { label: 'Finish', },
					delete: { label: 'Delete', },
			...
			fr: {
				translation: {
					...
					descriptionProj: { label: 'Description complète de votre projet : présentation, contexte (parties prenantes au projet), prérequis éventuellement nécessaires (compétences requises , connaissances dans l’utilisation de logiciels…), objectifs du projet, contraintes éventuelles, « livrables » attendus à la fin du projet, …', },
					...
					createProject: {
						...
						maxStudentNumber: " Si oui combien d’étudiants envisagez-vous maximum ?",
