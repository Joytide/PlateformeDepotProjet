			...
			en: {
				translation: {
					...
					createProject: {
						...
						multipleTeams: "Would you want/accept that several teams work on the project ?",
						maxTeamNumber: "If so, how many teams ?",
						biggerTeam:"Would you want a team with more than 5 students to work on the project ?",
						maxStudentNumber: "If so, how many students?",
						teamInfo: "Teams are initially formed by 4 or 5 students, working around 10h per week per student. Thus, your project is originally made up of one team of 4 or 5 students. However:",
			...
			fr: {
				translation: {
					...
					createProject: {
						...
						multipleTeams: "Souhaitez-vous/pouvez-vous avoir plusieurs équipes sur votre projet ?",
						biggerTeam:"Souhaitez-vous avoir une seule équipe de plus de 5 étudiants pour réaliser votre projet ?",
						maxTeamNumber: "Dans ce cas combien d'équipes maximum acceptez-vous ?",
						maxStudentNumber: "Dans ce cas combien d'étudiants maximum acceptez-vous ?",
						teamInfo: "Les équipes sont formées a priori de 4 ou 5 étudiants, travaillant à raison de 10h par semaine par étudiant. Votre projet est ainsi proposé a priori à une seule équipe de 4 ou 5 étudiants. Mais:",
