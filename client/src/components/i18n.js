			...
			en: {
				translation: {
					...
					createProject: {
                        ...
                        teamInfo2: "However, if your project requires more students or if you want to put multiple teams in competition, it is possible to have multiple teams in collaboration or competition.",
			...
			fr: {
				translation: {
					...
					createProject: {
                        ...
                        teamInfo2: "Mais si le travail demandé nécessite plus d’étudiants, ou si vous souhaitez mettre plusieurs équipes en concurrence ou en collaboration sur ce sujet, c’est possible.",
